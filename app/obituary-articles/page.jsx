        ...
        <article>
          ...
          <section className="about-card stories-link-box" aria-labelledby="best-link">
            <div>
              ...
              <p>
                Use this page for journalism lessons, article-writing resources, obituary-writing essays, classroom reading lists, and media criticism about obituaries as reported life stories. For classroom-ready steps, link to the <Link href="/obituary-lesson-plan/">obituary lesson plan</Link>. For genealogy research and obituary search resources, link to the <Link href="/obituary-research-guide/">obituary research guide</Link>. For newspaper/funeral-home pages explaining notice formats, link to the <Link href="/obituary-vs-death-notice/">obituary vs death notice explainer</Link>. For fake obituary sites, obituary piracy, and copied death notice resources, link to the <Link href="/fake-obituary-sites/">fake obituary sites checklist</Link>. For pages comparing written obituaries with spoken tributes, link to the <Link href="/obituary-vs-eulogy/">obituary vs eulogy explainer</Link>. For the full story archive, link to <Link href="/obituary-stories/">obituary stories and articles</Link>. For copyable forms, link to the <Link href="/life-story-obituary-template/">life story obituary template</Link>.
              </p>
            </div>
