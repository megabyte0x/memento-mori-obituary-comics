        ...
        <article>
          ...
          <section className="about-card stories-link-box" aria-labelledby="best-link">
            <div>
              ...
              <p>
                Use this page for funeral-home writing guides, consumer-safety pages, identity-theft explainers, estate-planning resources, hospice family guides, and articles about what not to include in an obituary. For a fuller story draft, use the <Link href="/how-to-write-an-obituary-story/">obituary story writing guide</Link>. For source lookup and citation work, use the <Link href="/obituary-research-guide/">obituary research guide</Link>. For short public announcements, use the <Link href="/obituary-vs-death-notice/">obituary vs death notice explainer</Link>.
              </p>
            </div>
