        ...
        <article>
          ...
          <section className="about-card stories-link-box worksheet-link-box" aria-labelledby="best-link">
            <div>
              ...
              <p>
                Use this page for library resource lists, funeral-home planning resources, genealogy prompts, grief-writing guides, and classroom worksheets. For genealogy search, citation, and obituary-record lookup resources, use the <Link href="/obituary-research-guide/">obituary research guide</Link>. For obituary/death-notice comparison pages, use the <Link href="/obituary-vs-death-notice/">obituary vs death notice explainer</Link>. For journalism lessons and reported obituary article resources, use the <Link href="/obituary-articles/">obituary articles page</Link>. For full lesson-plan repositories, use the <Link href="/obituary-lesson-plan/">obituary lesson plan</Link>. For prompt banks and legacy interview resources, use the <Link href="/obituary-writing-prompts/">obituary writing prompts page</Link>. For copyable formats, use the <Link href="/life-story-obituary-template/">life story obituary template</Link>. For sample structures, use the <Link href="/obituary-examples/">obituary examples page</Link>. For the longer explanation, use the <Link href="/how-to-write-an-obituary-story/">obituary story writing guide</Link>.
              </p>
            </div>
