        ...
        <article>
          ...
          <section className="about-card stories-link-box worksheet-link-box" aria-labelledby="best-link">
            <div>
              ...
              <p>
                Use this page for library resource lists, funeral-home planning resources, genealogy prompts, grief-writing guides, and classroom worksheets. For prompt banks and legacy interview resources, use the <Link href="/obituary-writing-prompts/">obituary writing prompts page</Link>. For sample structures, use the <Link href="/obituary-examples/">obituary examples page</Link>. For the longer explanation, use the <Link href="/how-to-write-an-obituary-story/">obituary story writing guide</Link>.
              </p>
            </div>
