        ...
        <section className="about-card stories-link-box" aria-labelledby="how-to-link">
          <div>
            ...
            <p>
              ...
              For journalism lessons and article-writing resources, use the <Link href="/obituary-articles/">obituary articles page</Link>. For genealogy, library, and obituary-search resources, use the <Link href="/obituary-research-guide/">obituary research guide</Link>. For newspaper and funeral-home explainers about notices, use the <Link href="/obituary-vs-death-notice/">obituary vs death notice page</Link>. For obituary-writing resources, use the <Link href="/how-to-write-an-obituary-story/">guide to writing an obituary story</Link>. For prompt lists and legacy interview questions, use the <Link href="/obituary-writing-prompts/">obituary writing prompts page</Link>. For template links, use the <Link href="/life-story-obituary-template/">life story obituary template</Link>. For example roundups, use the <Link href="/obituary-examples/">obituary examples page</Link>. For definitions of the format itself, use the <Link href="/what-are-obituary-comics/">obituary comics explainer</Link>.
            </p>
          </div>
