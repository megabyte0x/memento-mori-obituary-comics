...
export default async function ObituaryExamplesPage() {
  ...
  const schema = {
    ...
    "@graph": [
      publisherSchema(),
      {
        ...
        keywords: ["obituary examples", "obituary stories", "obituary writing", "visual obituaries"],
      },
      {
        "@type": "CollectionPage",
  ...
  return (
    <>
      ...
      <ResourceLayout
        currentPath="/obituary-examples/"
        kicker="Obituary examples"
        title="Obituary Examples"
