...
export const SITE_SHORT_NAME = "Final Notes";
...
export function publisherSchema() {
  return {
    ...
    name: SITE_NAME,
    alternateName: [SITE_SHORT_NAME, "Memento Mori"],
    url: absoluteUrl("/"),
    ...
    logo: {
      ...
      contentUrl: absoluteUrl("/assets/logo.png"),
      width: 1024,
      height: 1024,
    },
    publishingPrinciples: absoluteUrl("/about/"),
    knowsAbout: ["obituary comics", "visual biography", "obituary stories", "source-backed comics"],
    sameAs: SAME_AS_URLS,
  };
}
